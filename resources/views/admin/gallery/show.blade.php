                    ...
                    <div class="x_content">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="title" id="title" class="form-control col-md-7 col-xs-12" value="{{ $data->title }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                ...
                                <button class="btn btn-primary" onclick="postGallery({{ $data->id }});return false;">@lang('gallery/backend.post')</button>
                            </div>
                        </div>
                    </div>
                    <!-- X-content -->
    ...
    function postGallery(id) {
        $.ajax({
            ...
            if (data) {
                ...
                window.location.replace('{{ route("admin.gallery") }}');
            } else {
