					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="">
									<label>
										<input type="checkbox" class="js-switch" name="is_hot" value="1" {{ $data['is_hot']==1?"checked":"" }} /> 
									</label>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="">
									<label>
										<input type="radio" name="view_mode" id="view_mode_all" class="flat" value="all" {{ $data['view_mode']=='all'?"checked":"" }} /> @lang('news/backend.all') &nbsp
										<input type="radio" name="view_mode" id="view_mode_member" class="flat" value="member" {{ $data['view_mode']=='member'?"checked":"" }}/>&nbsp @lang('news/backend.only_member')
										<input type="radio" name="view_mode" id="view_mode_event" class="flat" value="event" {{ $data['view_mode']=='event'?"checked":"" }}/>&nbsp @lang('news/backend.event')
										<input type="radio" name="view_mode" id="view_mode_member" class="flat" value="association" {{ $data['view_mode']=='association'?"checked":""}} {{ Auth::user()->role =='collaborator'?"disabled":"" }}/>&nbsp @lang('news/backend.association')
									</label>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea id="content" name="content" class="form-control col-md-7 col-xs-12 my-editor">
									{{ $data['content'] }}
								</textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 text-center">
								...
								<button class="btn btn-primary">@lang('news/backend.edit')</button>
							</div>
						</div>
					</div>
					<!-- X-content -->
