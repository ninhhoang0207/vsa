																	...
																	<div class="list-block ">
																		<ul class="tintuc-list ">
																			<?php foreach ($news_news as $key => $value): ?>
																				<li>
																					<a href="{{ route('news.show',['title_slug'=>$value->title_slug]) }}" title=" "><i class="fa fa-plus-circle "></i>{{ str_limit($value->title,$limit=100,$end='...') }}
																					</a>
																				</li>
																			<?php endforeach ?>
																	...
																	<div class="row">
																		...
																		<div class="col-md-8 col-sm-8 col-xs-7">
																			<div class="box-info">
																				...
																				<br>
																				<span class="text">{{ str_limit($value->description,$limit=80,$end='...') }}</span>
																			</div>
																		</div>
																	</div>
																</div>
...
{{-- fix-nhanthongbao --}}
<!-- @include('includes/homepage.contact') -->
@endsection
