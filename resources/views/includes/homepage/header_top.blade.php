<header>
	...
	<!--row-1-->
	<div class="header-winner img-responsive">
		<div class="container">
			<div class="row">
				<div class="header-left">
					<div class="col-xs-12 col-md-9 col-sm-12">
						<div class="col-xs-4 col-sm-3 col-md-3">
							<a href="{{ route('homepage.index') }}"><img src="{{ asset('images/bg/4.png') }}" alt="vsalogo" class="img-responsive logo"></a>
						</div>
						...
						<a href="#"><img src="{{ asset('images/bg/2.png') }}" alt="vsalogo" class="img-responsive"></a>
					</div>
				</div>
			</div>
...
<!--Menu-->
<div class="submenu-reponsive menu-position">
	<div class="">
