									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="tintuc_left">
											<div class="link-block">
												<a href="# " class="tintuc left-news ">{{ $gallery->title }}</a>
												<div class="border-bottom "></div>
											</div>
											<h5><i>Ngày đăng: {{ Carbon\Carbon::parse($gallery->updated_at)->format('d/m/Y') }}</i> - <b>{{ isset($gallery->author->name)?$gallery->author->name:"Không rõ" }}</b></h5>
											<!-- <strong style="color: #0080ce"><i>Người viết:</i> {{ isset($gallery->author->name)?$gallery->author->name:"Không rõ" }}</strong> -->
											...
											<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:960px;height:480px;overflow:hidden;visibility:hidden;background-color:#24262e;">
												...
												<div data-u="slides" style="cursor:default;position:relative;top:0px;left:240px;width:720px;height:480px;overflow:hidden;">
													<?php foreach ($gallery->images as $key => $value): ?>
													<div>
														<img data-u="image" src="{{ Storage::url($value->url_image) }}" />
														<img data-u="thumb" src="{{ Storage::url($value->url_image) }}" />
													</div>
													<?php endforeach ?>
